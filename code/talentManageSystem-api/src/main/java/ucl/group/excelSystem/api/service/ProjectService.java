...
public interface ProjectService {
    ...
    HashMap<String, BigDecimal> getSalesIncrementAndDecrementUnitPriceHour(Integer projectId, Integer staffId);

    HashMap<String, String> getAmountRaisedUpperAndLowerLimit(Integer projectId, Integer staffId);

    HashMap<String, BigDecimal> getProcurementIncrementAndDecrementUnitPriceHour(Integer projectId, Integer staffId);
