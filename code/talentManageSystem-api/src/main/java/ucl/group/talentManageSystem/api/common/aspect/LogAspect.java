package ucl.group.talentManageSystem.api.common.aspect;
...
import ucl.group.talentManageSystem.api.common.enums.BusinessStatus;
import ucl.group.talentManageSystem.api.common.filter.PropertyPreExcludeFilter;
import ucl.group.talentManageSystem.api.common.service.AsyncLogService;
import ucl.group.talentManageSystem.api.common.utils.IpUtils;
import ucl.group.talentManageSystem.api.common.utils.SecurityUtils;
import ucl.group.talentManageSystem.api.common.utils.ServletUtils;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        ...
        catch (Exception exp)
        {
            ...
            log.error("操作日志记录出现异常，{}", exp.getMessage());
        }
        finally
        {
